...
void sendviatcp (char *tcpline, uint32_t buffer_size, float *buffer, int line_number) {
	int i=0;
	float tmp, scale=1.2;//1.5; //depend on maximum value of input, for test scale=1
...
int main(int argc, char **argv){
	...
	for (i=500 ; i<530 ; i++) {buff[i]=1.2;}
	for (i=800 ; i<815 ; i++) {buff[i]=1.2;}
